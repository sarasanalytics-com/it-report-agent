...
- Never fabricate data — only report what exists in the spreadsheets. IT issues come from an optional "IT Issues" sheet; when absent the report shows a placeholder (the ticketing-tool + email + Slack feed is a future integration).
